          ...
          >
            ...
            <div className="mt-4 grid grid-cols-3 gap-2 text-xs">
              <div>
                ...
                <p className="mt-1 font-medium text-ink">哔哩哔哩</p>
              </div>
              <div>
            ...
            >
              ...
              <td className={cn("px-4 py-4", compact && "hidden")}>
                <span className="inline-flex items-center gap-2 text-sm text-ink">
                  <span className="grid size-6 place-items-center rounded-md bg-[#fb7299]/10 text-[10px] font-bold text-[#d94d78]">
                    B
                  </span>
                  哔哩哔哩
                </span>
